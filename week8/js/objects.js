...
let person = {
        ...
        age:100,
        gender: "yes",
        interest: ["food", "breathing", "existence"],
        greetings: function(){
            alert(`hello ${this.name}! how are you`);
        },
        bio: function(){
            return `the interest of ${this.name} of age ${this.age} of gender ${this.gender}
            are ${this.interest.join(", ")}`;
        }
}
...
person.goodbye = function(){
    alert(`this ${this.name.firstname} signing off`)
}
