...
let orig6 = `Toronto Maple Leafs, Chicago Black Hawks, Dertroid Red wins, Boston Bruins, Montreal Canadians, New York Rangers`;
...
console.log(`last is ${orig6Array[orig6Array.length - 1]}`)
...
orig6Array.splice(2, 1, "Edmonton Oilers");
